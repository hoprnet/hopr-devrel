...
class Constants:
    ...
    REGEX_DICTIONARY = {
        ...
        'create_ticket_packet_check_balance': r'hopr-core:message:packet balances (?P<channel_balance>\d*) - (?P<channel_outstanding_balance>\d*) = (?P<channel_remaining_balance>\d*) should >= (?P<channel_expected_minimum>\d*)',
